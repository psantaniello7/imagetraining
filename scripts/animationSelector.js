const animatorSelectorComponent = () => ({
  schema: {
  ...
  init() {
    ...
    document.getElementById('inHandButton').addEventListener('resetAnim', () => {
      ...
      let closedButton = document.getElementById('closeAnimButton')
      this.animState = 'open'
      if (openButton != null || closedButton != null) {
    ...
    document.getElementById('inHandButton').addEventListener('click', () => {
      this.animState = 'open'
    })
    ...
    if(document.getElementById('closeAnimButton'))
      {
        this.animState = 'open'
      }
    })
...
export {animatorSelectorComponent}
